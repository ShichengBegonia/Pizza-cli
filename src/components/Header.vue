<template>
    <div class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul>
            ...
            <li><router-link :to="homeLink" class="nav-link">主页</router-link></li>
            <li><router-link :to="menuLink" class="nav-link">菜单</router-link></li>
            <li><router-link :to="adminLink" class="nav-link">管理</router-link></li>
            <li><router-link :to="aboutLink" class="nav-link">关于我们</router-link></li>
        </ul>
